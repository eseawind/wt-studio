...
public class RadioBoxFigure extends Label {

	private String title;
	private String value;

	public RadioBoxFigure(String title,String value) {
		//super(text);
	 ...
	 protected void paintFigure(Graphics graphics) {
	        ...
	        {
	        graphics.drawImage(Activator.getImageDescriptor(ImageResource.RADIO).createImage(), x, bound.y + bound.height/2-8);
