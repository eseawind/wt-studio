...
import com.wt.studio.plugin.modeldesigner.editor.handle.NodeMoveHandle;
import com.wt.studio.plugin.modeldesigner.editor.handle.NodeResizeHandle;

public class NodeSelectionEditPolicy extends ResizableEditPolicy {
	...
	protected List createSelectionHandles() {
		...
		/*if (selectedEditParts.size() == 1) {
			    editPart = (TableModelEditPart) getHost();
				editPart.reorder();
		}*/
		...
		if (directions == 0) {
			...
			// 0
			list.add(new NodeMoveHandle((GraphicalEditPart) getHost()));
	...
	public static void addHandles(GraphicalEditPart part, List handles) {
		handles.add(new NodeMoveHandle(part));
