...
public class ViewModelFigure extends RoundedRectangle
{
	...
	public ViewModelFigure()
	{
		setBackgroundColor(new Color(null,128,128,255));
		initTitleBar(this);
		createColumnArea(new Figure());
		createFooter(this);
	}
	...
	public BONodeModel getBlockModel()
	{
		return (ViewModel)rectangleModel;
	}

	public void setBlockModel(BONodeModel rectangleModel)
	{
		this.rectangleModel = rectangleModel;
	    this.setName(((ViewModel)rectangleModel).getName());
		this.repaint();
	}
	@Override
