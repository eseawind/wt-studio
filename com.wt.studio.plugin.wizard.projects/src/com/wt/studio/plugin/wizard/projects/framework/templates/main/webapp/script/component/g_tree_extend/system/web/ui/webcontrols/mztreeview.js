...
t.iconPath = System.path+"/../../../images/component/g_tree_extend/";
...
MzTreeView.prototype.render = function()
{
  ...
  loadCssFile(System.path +"/../../../css/component/g_tree_extend/mztreeview.css", "MzTreeView_CSS");
...
{
  var $=this.$$caller, s=$.dataSource[this.sourceIndex],target,data,url,checked,value;
  var icon=s.getAttribute("icon");
  //---
  var ctrue=s.getAttribute("checked");
  var cvalue=s.getAttribute("value");
  //---
  ...
  s+="<input style='width:16px;height:16px;' type='checkbox' "+ctrue+" value='"+cvalue+"' title='"+hint+"' id='"+this.sourceIndex+"' " +
  		" onclick='jlc(\""+this.sourceIndex.split('_')[0]+"\",\""+this.sourceIndex.split('_')[1]+"\")'>"; 
       if($.useRadio)
  s+="<input type='radio' name='mzRadio' style='width:16px;height:16px;' "+ctrue+" value='"+cvalue+"_"+hint+"'>";
