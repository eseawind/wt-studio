...
t.iconPath = System.path+"/../../../images/component/i_tree/";
...
MzTreeView.prototype.render = function()
{
  ...
  loadCssFile(System.path +"/../../../css/component/i_tree/mztreeview.css", "MzTreeView_CSS");
...
MzTreeNode.prototype.render = function(last)
{
  ...
  s+="<input style='width:16px;height:16px;' type='checkbox' "+ctrue+" value='"+cvalue+"' title='"+hint+"' id='"+$.index+"_checkbox_"+id+"' >"; 
       if($.useRadio)
