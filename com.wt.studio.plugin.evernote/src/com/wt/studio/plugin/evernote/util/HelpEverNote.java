...
public class HelpEverNote {
	...
	// Consumer Key: yinglin2268-5135
	// Consumer Secret: e3755dc1f297b79b
	...
	public static void main(String args[]) throws Exception {
		...
		HelpEverNote demo = new HelpEverNote();
		try {
			demo.listNotes();
			demo.createNote();
			demo.searchNotes();
	...
	private static Data readFileAsData(String fileName) throws Exception {
		...
		String filePath = new File("D://") + fileName;
