package com.wt.studio.plugin.querydesigner.actions;
...
import com.wt.studio.plugin.querydesigner.wizards.NewQueryDesignerWizard;
 ...
 */
public class ShowQueryDesignerViewAction implements IWorkbenchWindowActionDelegate
{
	 ...
	 * The constructor.
	 */
	public ShowQueryDesignerViewAction()
	{
	}
	...
	{
		// try {
		// window.getActivePage().showView(QueryDesignerView.ID);
		// } catch (PartInitException e) {
		// e.printStackTrace();
		// }
		NewQueryDesignerWizard data = new NewQueryDesignerWizard(this.selection);
