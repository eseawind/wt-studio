...
public class VerticalLayout extends XYLayout
{
	 ...
	 * of the child should be preserved, the preferred size would be a region which would hold all
	 * the children of the input figure. If no constraint is set, that child is ignored for
	 * calculation. If width and height are not positive, the preferred dimensions of the child are
	 * taken.
	 * 
	...
	public void layout(IFigure parent)
	{
		...
		while (children.hasNext()) {
			...
			if (bounds != null) {
				...
				bounds.setWidth(parent.getClientArea().width - 5);
			}
			if (bounds == null)
				continue;
