 ...
 * is used in the Activator, CodeGenWizard.
 * 
 */
public class OptionsPage extends AbstractWizardPage implements UIConstants {
	...
	public void createControl(Composite parent) {
	    ...
	    label.setText(Activator.getResourceString("page2.options.desc"));
		...
		testCaseCheckBoxButton
				.setText(Activator.getResourceString("page2.testcase.caption"));
...
//		lblClientside.setText(Activator
...
//		lblClientside.setLayoutData(gd);
		...
		syncOnlyRadioButton.setText(Activator
				.getResourceString(Activator.getResourceString("page2.sync.caption")));
		...
		asyncOnlyRadioButton
				.setText(Activator.getResourceString("page2.async.caption"));
...
//			this.syncOnlyRadioButton.setEnabled(false);
	...
	if ((text == null) || (text.trim().equals(""))|| (text.endsWith(".")) || (text.startsWith("."))) {
		updateStatus(Activator.getResourceString("page2.pachage.error.nolocation"));
		return;
	}
		updateStatus(null);
	}
