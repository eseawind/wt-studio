...
import com.wt.studio.plugin.ws.codegen.eclipse.util.ClassFileReader;
...
public class JavaSourceSelectionPage extends AbstractWizardPage{
    ...
    public void createControl(Composite parent) {
        ...
        addDirButton.setText(Activator
        ...
        addJarButton.setText(Activator
        ...
        removeEntryButton.setText(Activator
        ...
        tryLoadButton.setText(Activator
        	...
        	public void mouseUp(MouseEvent e) {
        		...
        		if (!ClassFileReader.tryLoadingClass(getClassName(),
        			...
        			while(it.hasNext()){
        				...
        				String errorMessage = nextObject==null?Activator
        			...
        			updateStatusTextField(true,Activator
